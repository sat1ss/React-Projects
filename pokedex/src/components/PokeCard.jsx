  ...
  async function fetchMoveData(move, moveUrl) {
    ...
    if (localStorage.getItem('pokemon-moves')) {
      try {
        ...
        console.error('Error parsing pokemon-moves from localStorage:', err);
      }
    }
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem('pokedex')) {
      try {
        ...
        console.error('Error parsing pokedex from localStorage:', err);
      }
    }
        ...
        {moves.map((moveObj, moveIndex) => {
          return (
            <button
              ...
              key={moveIndex}
              onClick={() => {
                console.log(`Fetching data for move: ${moveObj?.move?.name}`);
